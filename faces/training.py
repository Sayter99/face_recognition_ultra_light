...
onnx_path = script_path + '/models/ultra_light/ultra_light_models/ultra_light_640.onnx'
onnx_model = onnx.load(onnx_path)
predictor = prepare(onnx_model)
ort_session = ort.InferenceSession(onnx_path)
input_name = ort_session.get_inputs()[0].name

shape_predictor = dlib.shape_predictor(script_path + '/models/facial_landmarks/shape_predictor_5_face_landmarks.dat')
fa = face_utils.facealigner.FaceAligner(shape_predictor, desiredFaceWidth=112, desiredLeftEye=(0.3, 0.3))


TRAINING_BASE = script_path + '/faces/training/'
...
with tf.Graph().as_default():
    with tf.Session() as sess:
        ...
        saver = tf.train.import_meta_graph(script_path + '/models/mfn/m1/mfn.ckpt.meta')
        saver.restore(sess, script_path + '/models/mfn/m1/mfn.ckpt')
        ...
        with open(script_path + '/embeddings/embeddings.pkl', 'wb') as f:
